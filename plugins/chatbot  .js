let handler = m => m; 
 ...
 }else if (/^ ايانوكوجي عامل ايه|عامله ايه|عاملين ايه|كيفكم|عاملين ايه يشباب$/i.test(m.text)) { 
 responses = [ 
 ...
 }else if (/^ايانوكوجي|ايانوكوجي عمك| ايانوكوجي/i.test(m.text)) { 
 responses = [ 
 '*نعم يا قلب ايانوكوجي؟* ',  
 '*ايانوكوجي عمك👾* ',  
 '*ي عيون ايانوكوجي*',  
 ...
 responses = [ 
 '*اسمي ايانوكوجي يا غبي*',  
 '*مش عارف تقول ايانوكوجي؟*',  
 '*يحمار ترا قلنا اسمي ايانوكوجي*',  
 '*انت البوت*',  
 '*اسمي ايانوكوجي عايز اي؟*' 
 ]; 
